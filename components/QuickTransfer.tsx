...
const QuickTransfer = ({ accounts }: PaymentTransferFormProps) => {
            ...
            <FormItem className="border-t border-gray-800">
              <div className="payment-transfer_form-item pb-6 pt-5">
                <div className="payment-transfer_form-content">
                  ...
                  <FormDescription className="text-sm font-normal text-gray-300">
        ...
        <div className="flex items-center space-x-3 mt-5">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <div>
                  <FormLabel className="text-md w-full max-w-[280px] text-white">
